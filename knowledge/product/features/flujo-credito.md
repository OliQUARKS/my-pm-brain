...
- **IVA en cancelaciones — ¿aplica siempre o solo si usuario no paga antes?** Excel lo marca configurable (flag B8 = 1). Olivier observa: "me suena raro porque si el usuario la paga bien hasta el final, porqué le cobro la cancelación?" Pregunta abierta: ¿PERC quiere permitir al usuario calcular cancelación ANTES de solicitar (para que vea costo y decide)? ¿O es un costo que siempre se aplica? Impacta UX + fórmula de cálculo. (observation, [source/meetings/2026-05-27-whatsapp-preguntas-pendientes-perc.md](../../../source/meetings/2026-05-27-whatsapp-preguntas-pendientes-perc.md))
