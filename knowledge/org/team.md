...
> Squad, reporting lines, RACI. Updated when org structure shifts. Stakeholder-specific files live in [`stakeholders/`](../../stakeholders/).

## Squad
<!-- Quarks Alchemist — 3rd-party team contratada por PERC para PRD + diseño. -->
| Nombre | Rol | Empresa |
|---|---|---|
...
## Reporting
<!-- Quarks reporta a PERC. Dentro de Quarks, el PM reporta al COO/CTO. -->
- Olivier → Federico (COO, Quarks) y Juan Pablo Norverto (CTO, Quarks)
- El equipo Quarks reporta colectivamente a PERC (Seba/Sebastián como PO, Marcos Copello como CEO)

## Cross-functional partners
| Nombre | Rol | Empresa | Relevancia |
|---|---|---|---|
...
|---|---|---|---|---|
| Definición de alcance / prioridades | Olivier | Seba (PERC) | Marcos Copello | Federico, JPN |
| Decisiones técnicas | Nicolás | JPN | Seba | Olivier |
| Aprobación del PRD | Olivier | Seba + Marcos Copello | — | Federico |
