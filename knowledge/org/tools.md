...
> The stack. What lives where. Used during retrieval to know where evidence comes from.

## Analytics
<!-- Pre-producción. Sin analytics activo todavía. -->
N/A — producto no lanzado aún. Revisar post-producción.
...
## Documentation
- PRD principal: `source/adhoc/2026-05-21-prd-flujo-credito.md` (copia en este brain)
...
- **EXA (exact.ly)** — partner de co-branding para la tarjeta PERC. Logo requerido en la tarjeta física/digital ("PERC by Exa" o EXA sutil). Assets: https://docs.exact.ly/exa-app/exa-app-and-exa-card-assets (observation, [ingestion/adhoc/2026-03-06-whatsapp-grupo-perc.md](../../ingestion/adhoc/2026-03-06-whatsapp-grupo-perc.md), 2026-05-13)
- **VISA** — integración para emisión de tarjeta. Colores de diseño aprobados: Background RGB(23,28,35) / Foreground RGB(255,255,255) / Label RGB(255,255,255). (observation, [ingestion/adhoc/2026-03-06-whatsapp-grupo-perc.md](../../ingestion/adhoc/2026-03-06-whatsapp-grupo-perc.md), 2026-05-18)
