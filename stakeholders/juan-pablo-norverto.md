# Juan Pablo Norverto — CTO, Quarks Alchemist

## Snapshot
- Role: CTO, Quarks Alchemist
- Reports to / works with: Federico (COO), Nicolás (TL)
- Influence on my work: high
- Friction level: low

## What they care about
- Decisiones de arquitectura y viabilidad técnica del proyecto
- Validación del stack (Lambda / Java / TypeScript + integración Watson)
(intuition, PM, 2026-05-21)

## Concerns / watch-outs
TODO: confirmar en touchpoint. El mes de discovery técnico (source/adhoc/2026-05-21-prd-flujo-credito.md §5) es probablemente su foco inmediato.
...
## Touchpoint log
- 2026-09-16 — Discovery call Norton (cliente nuevo, no PERC). Lideró el encuadre metodológico ("antes de pensar cómo resolver, qué queremos resolver") y aportó la idea de captura de oportunidades de distribución geolocalizadas; queda a cargo de armar el primer plan de trabajo. [../ingestion/meetings/2026-09-16-norton-discovery.md](../ingestion/meetings/2026-09-16-norton-discovery.md)
