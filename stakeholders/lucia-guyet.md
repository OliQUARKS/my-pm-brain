# Lucía Guyet — UX/UI Designer, Quarks Alchemist
<!-- También: Lu -->

## Snapshot
- Role: UX/UI Designer, Quarks Alchemist
- Reports to / works with: Federico Fernandez (COO), Olivier (PM)
- Influence on my work: medium
- Friction level: low

## What they care about
- Experiencia del usuario y accesibilidad del flujo
- Coherencia del design system a lo largo de toda la aplicación
(intuition, PM, 2026-05-22)

## Concerns / watch-outs
TODO: confirmar en touchpoint.

## Communication style
Participativa, aporta perspectiva de UX con énfasis en el usuario final. (observation, 2026-05-20)
