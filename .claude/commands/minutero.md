...
Ver el mapa canónico: `briefings/_ciclo-preventa.md`. Dos cosas que importan acá:
...
**Input:** [build-context](https://github.com/OliQUARKS/my-pm-brain/blob/main/briefings/2026-07-frigorifico-merlo-build-context.md) + [discovery 23-jul](https://github.com/OliQUARKS/my-pm-brain/blob/main/source/meetings/2026-07-23-frigorifico-merlo-discovery.md) + call interna Oli↔Jony 24-jul.
...
**Output:** [minuta 23-jul](https://github.com/OliQUARKS/my-pm-brain/blob/main/briefings/2026-07-23-frigorifico-merlo-minuta.md), con header interno + "Quiénes somos" + flujo a validar + 7 pedidos de material + próximos pasos, en tono intermedio.
